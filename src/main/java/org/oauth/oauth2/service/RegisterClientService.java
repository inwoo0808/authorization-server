...
import org.oauth.oauth2.repository.RegisterRepository;
...
public class RegisterClientService {
    ...
    public RegisterClientService(RegisterRepository registerRepository, BCryptPasswordEncoder bCryptPasswordEncoder){
        this.registerRepository = registerRepository;
        this.bCryptPasswordEncoder = bCryptPasswordEncoder;
    }

    public RegisterEntity register(RegisterClientDto dto) {
        ...
        entity.setTokenSettings("{\"@class\":\"java.util.Collections$UnmodifiableMap\","
            ...
            + "\"settings.token.device-code-time-to-live\":[\"java.time.Duration\",600.000000000]}"
        );
