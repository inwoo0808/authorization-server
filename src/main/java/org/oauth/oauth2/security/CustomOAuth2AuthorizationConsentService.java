...
import org.oauth.oauth2.repository.ConsentRepository;
...
public class CustomOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
    ...
    public CustomOAuth2AuthorizationConsentService(ConsentRepository consentRepository, RegisteredClientRepository registeredClientRepository) {
